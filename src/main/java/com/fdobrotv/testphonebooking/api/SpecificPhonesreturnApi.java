...
import com.fdobrotv.testphonebooking.dto.SpecificPhoneReturnIn;
...
public interface SpecificPhonesreturnApi {
    ...
    /**
     * POST /specificPhones:return : Return a \&quot;specific phone\&quot; by id
     *
     * @param specificPhoneReturnIn  (optional)
    ...
    @RequestMapping(
        ...
        value = "/specificPhones:return",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    
    default ResponseEntity<SpecificPhoneBook> returnSpecificPhoneById(
        @Parameter(name = "SpecificPhoneReturnIn", description = "") @Valid @RequestBody(required = false) SpecificPhoneReturnIn specificPhoneReturnIn
    ) {
