...
public class User {
   ...
   */
  public User(UUID id, String firstName, String lastName, String middleName, String role, String phone, String email, OffsetDateTime createdAt) {
    this.id = id;
  ...
  */
  @NotNull 
  @Schema(name = "role", example = "Tester", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("role")
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, firstName, lastName, middleName, role, phone, email, createdAt);
  }
