...
public class PhoneMarkIn {
   ...
   */
  public PhoneMarkIn(String name) {
    this.name = name;
  }

  public PhoneMarkIn name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    PhoneMarkIn phoneMarkIn = (PhoneMarkIn) o;
    return Objects.equals(this.name, phoneMarkIn.name);
  }
